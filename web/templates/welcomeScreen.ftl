		...
		<section class="primary">
			...
			<div class="row">
    			<div id="signupOne" class="col-md-5" >
        			<img src="${baseUrl}images/orcidSignup1.png" height="46" width="393"/>
    			</div>
    			<div id="signupTwo" class="col-md-5" >
        			<img src="${baseUrl}images/orcidSignup2.png" height="238" width="442"/>
    			</div>
			</div>
			<div id="rowTwo" class="row">
				<div id="registerOne" class="col-md-5" >
    				<img src="${baseUrl}images/orcidRegister1.png" height="100" width="400"/>
				</div>
				<div id="registerTwo" class="col-md-5" >
    				<img src="${baseUrl}images/orcidRegister2.png" height="303" width="493"/>
				</div>
    		</div>
			<div id="rowThree" class="row">
				<div id="searchOne" class="col-md-5" >
    				<img src="${baseUrl}images/orcidSearch1.png" height="97" width="441"/>
				</div>
				<div id="searchTwo" class="col-md-5" >
    				<img src="${baseUrl}images/orcidSearch2.png" height="290" width="450"/>
				</div>
    		</div>
